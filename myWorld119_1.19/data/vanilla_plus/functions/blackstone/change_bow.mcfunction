...
item replace entity @s weapon.offhand with minecraft:tipped_arrow{display:{Name:'{"text":"衰弱の矢","italic":false}'},CustomModelData:9999,CustomPotionEffects:[{Id:20b,Amplifier:0b,Duration:100}],CustomPotionColor:0}